...
A line plot is applied to manifest the activity changing pattern according to time. It can be seen that while the pattern of male in all three education groups look similar, the activity of female in "More than high school" group shows siginificant difference compared with the other two groups.