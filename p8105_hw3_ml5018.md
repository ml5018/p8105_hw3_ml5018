...
all the plots generated. A column and density plot are drawn to compare
between different years and response groups.
...
chosen. And for different resonse groups, the “poor” group possesses a
significantly different density and distribution compared with other
groups, which tend to overlap with each other on the density plot.
